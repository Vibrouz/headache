...
## Motivation
I and my friend [Barok-y](https://github.com/Barok-y/) built this mini project together to understand how file type detection works at the binary level (magic bytes), parsing and matching binary signatures from a database of known signatures, how attackers might disguise malicious files by changing extensions, Basic CLI argument parsing and colored terminal output in Python
